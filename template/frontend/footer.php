...
<footer class="off-white-bg2 pt-95 bdr-top pt-sm-55">
    ...
    <div class="footer-top">
        <div class="container">
            ...
            <div class="row mb-60">
                <div class="col-xl-7 col-lg-7 mx-auto col-md-8">
                    ...
                    <div class="single-footer mb-sm-40">
                        ...
                        <div class="footer-content">
                            ...
                            <div class="payment mt-25 bdr-top pt-30">
                                <a href="#"><img class="img" src="public/layout/img/payment/1.png" alt="payment-image"></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="footer-middle-content pt-20 pb-30">
                <ul class="social-footer">
                    ...
                    <li><a href="#"><img src="public/layout/img/icon/social-img1.png" alt="google play"></a></li>
                    <li><a href="#"><img src="public/layout/img/icon/social-img2.png" alt="app store"></a></li>
                </ul>
            </div>
        </div>
        <!-- Container End -->
    ...
    <div class="footer-bottom pb-30">
        <div class="container">
            ...
            <div class="copyright-text text-center">
                <p>Copyright © 2023 <a target="_blank" href="#">Truemart</a> All Rights Reserved.</p>
            </div>
        </div>
        <!-- Container End -->
    </div>
...
<script src="public/layout/js/vendor/jquery-3.2.1.min.js"></script>
<script src="public/layout/js/vendor/jquery-migrate-3.3.2.min.js"></script>
<!-- Countdown js -->
<script src="public/layout/js/jquery.countdown.min.js"></script>
<!-- Mobile menu js -->
<script src="public/layout/js/jquery.meanmenu.min.js"></script>
<!-- ScrollUp js -->
<script src="public/layout/js/jquery.scrollUp.js"></script>
<!-- Nivo slider js -->
<script src="public/layout/js/jquery.nivo.slider.js"></script>
<!-- Fancybox js -->
<script src="public/layout/js/jquery.fancybox.min.js"></script>
