                ...
                <form class="form-register" action="#">
                    <fieldset>
                        ...
                        <div class="form-group d-md-flex align-items-md-center">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" id="l-name" placeholder="Nguyễn văn A">
                            </div>
                        </div>
                        <div class="form-group d-md-flex align-items-md-center">
                        ...
                        <div class="form-group d-md-flex align-items-md-center">
                            <label class="control-label col-md-2" for="number"><span class="require">*</span>SĐT</label>
                            <div class="col-md-10">
                                <input type="email" class="form-control" id="number" placeholder="0123456789">
                            </div>
                        </div>
                    </fieldset>
                    <fieldset>
                    ...
                    <div class="terms">
                        <div class="float-md-right">
                            <span>Bạn có đồng ý với  <a href="#" class="agree"><b>điều khoản</b></a></span>
