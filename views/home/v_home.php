                ...
                if ($product_hot && $product_hot->num_rows > 0) { ?>
                    ...
                    while ($product_HotDeals = $product_hot->fetch_assoc()) { ?>
                        ...
                        <div class="single-product">
                            <!-- Product Image Start -->
                            <div class="pro-img">
                                <a href="product.php?proid=<?php echo $product_HotDeals['productId']?>">
                           ...
                           if ($product_new && $product_new->num_rows > 0) { 
                            ...
                            while ($product = $product_new->fetch_assoc()) { ?>
                                ...
                                <div class="single-product">
                                    <!-- Product Image Start -->
                                    <div class="pro-img">
                                        <a href="product.php?proid=<?php echo $product['productId']?>">  
                                            <img class="primary-img" src="admin/uploads/<?php
                                    ...
                                    <div class="pro-content">
                                        <div class="pro-info">
                                            ...
                                            <p><span class="price"><?php
                                            echo $product['price'] . "" . "VNĐ"; ?></span><del class="prev-price">$105.50</del></p>
                ...
                if ($product_like && $product_like->num_rows > 0) { 
                    ...
                    while ($product_YouMayLike = $product_like->fetch_assoc()) { ?>
                        ...
                        <div class="single-product">
                            <!-- Product Image Start -->
                            <div class="pro-img">
                                <a href="product.php?proid=<?php echo $product_YouMayLike['productId']?>">
                                    <img class="primary-img" src="admin/uploads/<?php
                            ...
                            <div class="pro-content">
                                <div class="pro-info">
                                    ...
                                    <p><span class="price"><?php
                                    echo $product_YouMayLike['price'] . "" . "VNĐ"; ?></span><del class="prev-price">$105.50</del></p>
                                    <div class="label-product l_sale">20<span class="symbol-percent">%</span></div>
                                </div>
                                <div class="pro-actions">
                                    <div class="actions-primary">
